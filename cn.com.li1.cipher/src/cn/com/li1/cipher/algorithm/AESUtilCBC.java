...
import cn.com.li1.cipher.parse.ParseSystemUtil;
 ...
 *
 */
public class AESUtilCBC {

	public static void main(String[] args) {

		// byte[] a=encrypt("123456","lilu");
		// System.out.println("加密后的内容：" +Arrays.toString(a));
		// byte[] b=decrypt(a, "lilu");
		// System.out.println("解密后的内容："+new String(b));
		//
		String content = "美女你好";
		...
		System.out.println("加密后的内容：" + Arrays.toString(encrypt));
		...
		// System.out.println(new String(twoStrResult));
		// System.out.println("2进制的密文：" + Arrays.toString(twoStrResult));

		// 解密
		byte[] decrypt = decrypt(encrypt, password);
		System.out.println("解密后的内容：" + new String(decrypt));
		// System.out.println("解密后的内容：" + Arrays.toString(decrypt));

		byte[] decrypt2 = decrypt(ParseSystemUtil.parseHexStr2Byte("AD87DCCA18366C37028E2E98CA4ADEA6"), password);
		System.out.println("解密后的内容2：" + new String(decrypt2));
	}
